...
- **5_EDA.ipynb`**: Generate Figure 1-3 in the paper.
- **6_VAR_log.do**:  Conduct all the time-series analysis on the merged data, including ADF test, VAR and impulse response analysis.